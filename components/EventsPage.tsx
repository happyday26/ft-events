    ...
    <>
      ...
      <main className="mx-auto max-w-5xl px-4 py-8 sm:px-6">
        <div className="mb-4 flex flex-wrap items-center gap-4">
          <a
            href="https://www.lcsd.gov.hk/en/programmes/programmeslist/culture/culture_prog.html"
            target="_blank"
            rel="noopener noreferrer"
            className="text-sm font-medium text-forest-700 hover:underline"
          >
            LCSD Culture Programmes →
          </a>
        </div>

        <div className="mb-6 rounded-xl bg-forest-50 px-4 py-3 text-sm text-forest-800 ring-1 ring-forest-200">
          Your events hub — category colors stand in for photos until you add images.
        </div>
