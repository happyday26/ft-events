...
export const MEDIA_LINKS: MediaLink[] = [
  ...
  {
    id: "simple-life-at-50-mission",
    label: "使命感 — Simple Life at 50",
    href: "https://www.simplelifeat50.com/065697321142/blog-post-title-three-2026-aug15",
    note: "Simple Life at 50 · 使命感 (15 Aug 2026)",
  },
  {
    id: "stanford-gsb-how-to-change",
    label: "Stanford GSB: How to Change",
    href: "https://www.gsb.stanford.edu/insights/how-change-building-better-habits-behaviors-getting-out-your-own-way",
    note: "Think Fast, Talk Smart · Katy Milkman on habits and behavior",
  },
  {
    id: "life-hacking",
    label: "Life Hacking",
    href: "https://www.lifehack.org/",
    note: "LifeHack · productivity and self-improvement",
  },
  {
    id: "channel-b",
    label: "體驗頻道 Channel B",
    href: "https://www.channelb.org/",
    note: "Life wisdom, spiritual care & cultural arts",
  },
  {
    id: "farnam-street",
    label: "Farnam Street",
    href: "https://fs.blog/",
    note: "Mental models, decision-making & learning",
  },
  {
    id: "bbc-happiness-half-hour",
    label: "BBC Sounds: The Happiness Half Hour",
    href: "https://www.bbc.co.uk/sounds/brand/p08r2ymx",
    note: "BBC Radio Bristol · science-based happiness strategies",
  },
  {
    id: "school-of-life",
    label: "The School of Life",
    href: "https://www.theschooloflife.com/",
    note: "Replaces The Philosophers’ Mail / Book of Life",
  },
  {
    id: "goalcast",
    label: "Goalcast - The World's Most Powerful Stories",
    href: "https://www.goalcast.com/",
    note: "Stories of purpose, resilience and motivation",
  },
  {
    id: "yc-startup-school",
    label: "Y Combinator Startup School",
    href: "https://www.startupschool.org/",
    note: "Free YC course for founders",
  },
  {
    id: "hkpl-login",
    label: "Hong Kong Public Libraries",
    href: "https://www.hkpl.gov.hk/en/login.html",
    note: "HKPL · member login",
  },
];
